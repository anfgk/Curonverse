import Temperature from "@/app/result/Temperature";
...
// 리듬별 온도 데이터
export const temperatureData: Record<string, TemperatureData> = {
  SparkFlame: {
    title: "때문에, 감정은 과열된\n온도를 유지하고 있어요.",
    description:
...
// 리듬 이름에 대한 타입 정의
export type RhythmName = keyof typeof RHYTHM_COLORS;

// 리듬에 따른 색상 정보 가져오기
export const getRhythmColor = (rhythmName: RhythmName) => {
  return RHYTHM_COLORS[rhythmName] || RHYTHM_COLORS.QuietSync;
};
